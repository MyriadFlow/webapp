...
function Profile() {
  ...
  const updateData = async (e) => {
    ...
    try {
      if (!updateProfile.name.trim() || !updateProfile.location.trim())
              ...
              >
                <div className="relative py-4 bg-white shadow-md rounded border border-gray-400">
                  ...
                  >
                    ...
                    <label
                      for="upload"
                      className="flex flex-col items-center gap-2 cursor-pointer pt-16"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="flex items-center justify-start -mt-20 ml-10">
                    ...
                    <div className="rounded-full h-36 w-36 ring-offset-2 ring-1 ring-black bg-gray-400">
                      <label
                        for="upload"
                        className="flex flex-col items-center gap-2 cursor-pointer mt-14"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-10 w-10 fill-white stroke-indigo-500"
      ...
      <div className="dark:body-back body-back-light pb-32">
        {profileDetails?.coverPictureUrl ? (
          <div
            ...
            style={{
              backgroundImage: `url(https://cloudflare-ipfs.com/ipfs/${removePrefix(
                profileDetails?.coverPictureUrl
              )})`,
        ...
        <div className=" m-2 flex flex-row items-center justify-start">
          <div className="lg:mt-10 md:mt-10 mt-4 lg:ml-16 md:ml-16 ml-4">
            <div>
              <p className="dark:text-white text-gray-800 text-2xl font-bold">
                {profileDetails?.name}
              </p>
            </div>
            <div>
              <p className="dark:text-white text-gray-800 mt-12 text-xl">
              ...
              <div className="flex lg:flex-row md:flex-row flex-col mt-4">
                ...
                <div
                  className="flex lg:ml-12 md:ml-12 dark:text-white text-gray-800 cursor-pointer"
                  onClick={() => {
                ...
                >
                  ...
                  <p className="text-xl ml-2 hidden lg:block md:block">
                    {profileDetails?.walletAddress}
                  </p>
                  <p className="text-xl ml-2 block lg:hidden md:hidden">
                    Copy address
                  </p>
                </div>
              </div>
