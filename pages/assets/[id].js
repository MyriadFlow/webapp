                            ...
                            <div class="w-full lg:w-1/2 order-2">
                                <div class="border rounded-md w-full px-4 py-3">
                                    <div class="flex items-center justify-between my-3">
                                        <h3 class="text-gray-500 font-medium">NFT Details</h3>
                                    </div>
                                    <div class="flex items-center justify-between my-4">
                                        <h3 class="text-gray-700 font-medium">Contract Address</h3>
                                        <span class="text-gray-600 text-sm">{asset.marketItems[0].nftContract}</span>
                                    </div>
                                    <div class="flex items-center justify-between my-4">
                                        <h3 class="text-gray-700 font-medium">Token ID</h3>
                                        <span class="text-gray-600 text-sm">{asset.marketItems[0].tokenId}</span>
                                    </div>
                                    <div class="flex items-center justify-between my-4">
                                        <h3 class="text-gray-700 font-medium">Blockchain</h3>
                                        <span class="text-gray-600 text-sm">ETHEREUM</span>
                                    </div>
                                    <div class="flex items-center justify-between -my-4">
                                        <h3 class="text-gray-700 font-medium">IPFS</h3>
                                        <span class="text-gray-600 text-sm"><a href={imgurl} className="text-gray-600"><BsArrowUpRight/></a></span>
                                    </div>
                                    <div class="flex items-center justify-between -my-4">
                                        <h3 class="text-gray-700 font-medium">IPFS Metadata</h3>
                                        <span class="text-gray-600 text-sm"><a href={nfturl} className="text-gray-600"><BsArrowUpRight/></a></span>
                                    </div>
                                    <div class="flex items-center justify-between -my-4 pb-4">
                                        <h3 class="text-gray-700 font-medium">Etherscan Transaction</h3>
                                        <span class="text-gray-600 text-sm"><a href={transaction} className="text-gray-600"><BsArrowUpRight/></a></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="flex justify-center lg:justify-end">
                                    <div class="border rounded-md max-w-md w-full px-4 py-3">
                                        <div class="flex items-center justify-between">
                                            <h3 class="text-gray-700 font-medium">Asset Worth</h3>
                                        ...
                                        <div class="flex justify-between mt-6">
                                            ...
                                            <span class="text-gray-600 mt-6">{asset.marketItems[0].price}</span>
                                        </div>
