      ...
      <div className="min-h-screen p-8 mx-auto bg-[#f8f7fc] dark:bg-[#131417] dark:body-back body-back-light">
        <div className="flex flex-col lg:flex-row">
          <div className="w-1/3 border border-gray-600 p-4 mr-4">
            ...
            <div>
              Lorem ipsum dolor sit amet. Et nihil laborum est facere galisum
              vel fuga saepe est quidem accusantium hic expedita sapiente ut
              molestiae sapiente. Quo quod nostrum qui optio tenetur eum
              corporis nesciunt qui molestias cumque in voluptate dolorem non
              sequi voluptates.
            </div>
          </div>
          ...
          <div className="w-2/3">
            <div className="pl-10 border border-gray-600 p-4 mb-4">
              ...
              <div className="flex">
                <button className="flex gap-x-2 items-center justify-center px-10 py-3 my-4 text-sm font-medium rounded-lg bg-white text-black">
