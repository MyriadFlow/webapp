...
export default function CreatorDashboard() {
  ...
  return (
    <Layout
      title="Dashboard"
      description="You will find all your created NFTs, assets you buy, sell and market here."
    >
                          ...
                          <div>
                            ...
                            <div className=" flex items-center justify-between mb-2 mt-3">
                              ...
                              <div className="flex items-center">
                                ...
                                <div className="font-extralight dark:text-gray-400"></div>
                              </div>
                            </div>
                            <div></div>
                          </div>
