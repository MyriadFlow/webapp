  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A NFT Marketplace to Explore the Digital Gold Mine, that Supports the Creators. A Place where you can Create, Collect and Sell Digital Assets."
        ></meta>
        <meta
          property="og:url"
          content="https://marketplace-myriadflow.netlify.app"
        ></meta>
        <meta
          name="keywords"
          content=" crypto, wallet, metamask, nft, asset, marketplace, collections"
        ></meta>
