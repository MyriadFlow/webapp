    ...
    <Layout title="Drops" description="Airdrop Alert, Claim Your NFTs Now!">
      <div className='flex dark:body-back body-back-light mx-auto items-center justify-center lg:flex-row flex-col'>
        ...
        <div className='items-center flex flex-col'>
          <div className='reward-text text-4xl font-bold lg:mt-18 md:-mt-20'> Airdrop Alert</div>
          <div className='mt-16'>
            <div className='text-center text-2xl font-bold text-gray-500 dark:text-white'>Claim Your NFTs Now!</div>
            {/* <div className='text-center text-2xl font-bold text-gray-500 dark:text-white'>Now!</div> */}
          </div>
          <div className='text-gray-500 dark:text-gray text-sm mt-10'>Currently you do not meet the</div>
