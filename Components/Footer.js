      ...
      <div className="bg-white dark:bg-gray-900">
        <div className="m-auto text-gray-800 text-sm flex flex-col md:flex-row md:justify-between max-w-6xl dark:text-white py-2 px-1" style={{color:"black"}}>
          ...
          <div className="flex gap-x-4 items-center">
            ...
            >
              <Link href="" className='hover:text-sky-500'><TelegramIcon /></Link>
            </Link>
            <Link
              ...
              className="hover:text-sky-700 text-blue-500 dark:text-white"
            >
              <Link href="" className='hover:text-sky-500'><TwitterIcon /></Link>
            </Link>
            <Link
              ...
              className="hover:text-sky-700 text-blue-500 dark:text-white"
            >
              <Link href="" className='hover:text-sky-500'><SiDiscord size={22} /></Link>
            </Link>
          </div>
        </div>
      </div>
