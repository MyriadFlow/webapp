                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 lg:grid-cols-5 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            { resdata && (<div className="flex mt-4 space-x-5 sm:mt-0">
                                    <Link href={resdata?.Storefront.discord} target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                    ...
                                    <Link href={resdata?.Storefront.twitter} target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                    ...
                                    <Link href={resdata?.Storefront.instagram} target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                ...
                                { resdata && (<div className="flex mt-4 space-x-5">
                                    <Link href={`mailto:${resdata?.Storefront.mailId}`} className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
